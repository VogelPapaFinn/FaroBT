...
/* CUSTOM MACROS - DEFINED BY VOGELPAPAFINN */
#define SPDLOG_LOG_INFO(logger, msg) SPDLOG_LOGGER_INFO(spdlog::get(logger), msg)
#define SPDLOG_LOG_TRACE(logger, msg) SPDLOG_LOGGER_TRACE(spdlog::get(logger), msg)
#define SPDLOG_LOG_WARN(logger, msg) SPDLOG_LOGGER_WARN(spdlog::get(logger), msg)
#define SPDLOG_LOG_CRITICAL(logger, msg) SPDLOG_LOGGER_CRITICAL(spdlog::get(logger), msg)
/* CUSTOM MACROS - DEFINED BY VOGELPAPAFINN */
